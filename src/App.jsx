    ...
    <div className="app">
      ...
      <header className="header">
        <div className="container">
          <div className="logo">🏢 Orman İşletme Şefliği</div>
        ...
        <div className="container">
          ...
          <div className="services-grid">
            ...
            <div className="service-card">
              ...
              <p>Orman İşletme Şefliğiin büyümesine katkı sağlayacak stratejiler ve çözümler.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="contact-content">
            <div className="contact-info">
              ...
              <div className="info-item">
                ...
                <div>
                  <h3>Adres</h3>
                  <p>Çarşı, Cumhuriyet Cd. No:48, 48400 Bodrum/Muğla, Türkiye</p>
                </div>
              </div>
      ...
      <footer className="footer">
        <div className="container">
          <div className="footer-content">
            ...
            <div className="footer-section">
              <h4>İletişim</h4>
              <p>+902562257515<br/>info@bodrumpm.com</p>
            </div>
          </div>
          <div className="footer-bottom">
            <p>&copy; 2026 Orman İşletme Şefliği. Tüm hakları saklıdır.</p>
